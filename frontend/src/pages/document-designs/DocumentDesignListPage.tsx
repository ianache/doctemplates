    ...
    <section className="flex flex-col gap-lg">
      ...
      <div className="grid gap-md md:grid-cols-4">
        <div className="rounded border border-outline-variant bg-surface-container-lowest p-md">
          <p className="font-label-caps text-on-surface-variant font-bold uppercase">All Designs</p>
          <p className="mt-base font-headings text-headline-md text-on-surface font-bold">{statusCounts.all}</p>
        </div>
        {(["active", "draft", "superseded"] as const).map((key) => (
          ...
          >
            <p className="font-label-caps text-on-surface-variant font-bold uppercase">{STATUS_LABELS[key]}</p>
            <p className="mt-base font-headings text-headline-md font-bold">{statusCounts[key]}</p>
          </button>
        ))}
      </div>

      <div className="flex flex-wrap items-end gap-md rounded border border-outline-variant bg-surface-container-lowest p-md shadow-sm">
        ...
        <button
          className="rounded border border-outline-variant bg-surface-container px-md py-2 font-bold uppercase tracking-wide text-label-caps text-secondary hover:bg-surface-container-high active:scale-95 transition-all"
          type="button"
          onClick={() => {
            setQuery("");
            setStatus("All");
      ...
      {error ? (
        ...
        <div className="flex flex-col overflow-hidden rounded border border-outline-variant bg-surface-container-lowest shadow-sm">
