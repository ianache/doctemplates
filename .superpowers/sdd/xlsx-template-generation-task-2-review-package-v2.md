...
+
 ...
 name = "typing-extensions"
 version = "4.16.0"
@@ -1817,3 +2822,94 @@ sdist = { url = "https://files.pythonhosted.org/packages/da/9a/3b29831d8617ecbcf
 wheels = [
...
def test_upload_rejects_renamed_macro_enabled_workbook(
    ...
    for include_vba_project in (False, True):
        ...
        assert response.status_code == 400
        assert response.json()["detail"] == "Macro-enabled workbooks are not supported"
